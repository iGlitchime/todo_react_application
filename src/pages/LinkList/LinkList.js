    ...
    <div className="App__row row grid-x">
        <div className="App__column medium-1">
            <div className="App__menu vertical menu">
                <h2 className='App__menu_icon '>
                    <i className="step fi-align-justify size-48"></i>
                </h2>
                <Link to="/">
                    <h2 className='App__menu_icon'>
                        <i className="step fi-home size-48" alt="all tasks"></i>
                    </h2>

                </Link>
                <Link to="/donetasks">
                    <h2 className='App__menu_icon'>
                        <i className="step fi-trophy size-48" alt="active tasks"></i>
                    </h2>
                </Link>
                <Link to="/currenttasks">
                    <h2 className='App__menu_icon'>
                        <i className="step fi-trash size-48" alt="done tasks"></i>
                    </h2>
